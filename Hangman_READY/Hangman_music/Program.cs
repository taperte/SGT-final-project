...
namespace Hangman_music
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Console.Beep(NoteFrequency(Note.D4), NoteDuration(4));
                Console.Beep(NoteFrequency(Note.G3), NoteDuration(4));
                Console.Beep(NoteFrequency(Note.A3sh_B3fl), NoteDuration(8));
                Console.Beep(NoteFrequency(Note.C4), NoteDuration(8)); 
            }
            Console.Beep(NoteFrequency(Note.D4), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.G3), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.A3sh_B3fl), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.F4), NoteDuration(2, 1));
            Console.Beep(NoteFrequency(Note.A3sh_B3fl), NoteDuration(2, 1));
            Console.Beep(NoteFrequency(Note.D4sh_E4fl), NoteDuration(8));
            Console.Beep(NoteFrequency(Note.D4), NoteDuration(8));
            Console.Beep(NoteFrequency(Note.F4), NoteDuration(2));
            ...
            {
                Console.Beep(NoteFrequency(Note.C4), NoteDuration(4));
                Console.Beep(NoteFrequency(Note.F3), NoteDuration(4));
                Console.Beep(NoteFrequency(Note.G3sh_A3fl), NoteDuration(8));
                Console.Beep(NoteFrequency(Note.A3sh_B3fl), NoteDuration(8)); 
            }
            Console.Beep(NoteFrequency(Note.C4), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.F3), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.G3sh_A3fl), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.G4), NoteDuration(2, 1));
            Console.Beep(NoteFrequency(Note.C4), NoteDuration(2, 1));
            Console.Beep(NoteFrequency(Note.D4sh_E4fl), NoteDuration(8));
            Console.Beep(NoteFrequency(Note.F4), NoteDuration(8));
            ...
            Console.Beep(NoteFrequency(Note.A3sh_B3fl), NoteDuration(2, 1));
            Console.Beep(NoteFrequency(Note.D4), NoteDuration(2));
            Console.Beep(NoteFrequency(Note.D4sh_E4fl), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.D4), NoteDuration(2, 1));
            for (int i = 0; i < 3; i++)
            {
                Console.Beep(NoteFrequency(Note.C4), NoteDuration(4));
                Console.Beep(NoteFrequency(Note.G3), NoteDuration(4));
            ...
            Console.Beep(NoteFrequency(Note.D4sh_E4fl), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.G4sh_A4fl), NoteDuration(8));
            ...
            Console.Beep(NoteFrequency(Note.G4), NoteDuration(8));
            Console.Beep(NoteFrequency(Note.A4sh_B4fl), NoteDuration(8));
            Console.Beep(NoteFrequency(Note.G4sh_A4fl), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.C4), NoteDuration(4));
            Console.Beep(NoteFrequency(Note.F4), NoteDuration(8));
            Console.Beep(NoteFrequency(Note.G4), NoteDuration(8));
            Console.Beep(NoteFrequency(Note.G4sh_A4fl), NoteDuration(4));
            ...
            {
                Console.Beep(NoteFrequency(Note.D4sh_E4fl), NoteDuration(4));
                Console.Beep(NoteFrequency(Note.F4), NoteDuration(4)); 
            }
            for (int i = 0; i < 3; i++)
            {
                Console.Beep(NoteFrequency(Note.G4), NoteDuration(4));
